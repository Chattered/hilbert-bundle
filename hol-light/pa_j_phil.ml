...
EXTEND
  ...
  module_expr:
    ...
    (* Phil: Allow lower case functor parametrs *)
    [ [ "functor"; "("; i = V ident "id" ""; ":"; t = module_type; ")";
        "->"; me = SELF ->
          <:module_expr< functor ( $_uid:i$ : $t$ ) -> $me$ >>
  ...
  mod_expr_ident:
    ...
    (* Phil: Allow lower case module identifiers. *)
    | [ i = V ident -> <:module_expr< $_uid:i$ >> ] ]      
  ;
  str_item:
    [ "top"
      ...
      (*     <:str_item< module type $_uid:i$ = $mt$ >> *)
            (* Phil: allow lower case module type names *)
  ...
  ;
  mod_binding:
    (* Phil: Allow lower case module bindings *)
    [ [ i = V ident; me = mod_fun_binding -> (i, me) ] ]
  ...
  mod_fun_binding:
    [ RIGHTA
      ...
      (*     <:module_expr< functor ( $uid:m$ : $mt$ ) -> $mb$ >> *)
        (* Phil: Allow lower case module functor parameters *)
      [ "("; m = ident; ":"; mt = module_type; ")"; mb = SELF ->
          <:module_expr< functor ( $uid:m$ : $mt$ ) -> $mb$ >>
