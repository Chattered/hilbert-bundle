(* This is a dirty script, just showing that you can get the axiom of infinity
   much more simply if you use epsilon rather than iota. Neither I nor my
   supervisor thought this was particularly interesting, but I've left it here
   just the same. *)
